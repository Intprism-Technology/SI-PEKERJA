                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td align="center" valign="middle" style="padding:13px;">
                                                            <a href="#" title="START NOW" target="_blank" style="font-size: 14px; line-height: 1.5; font-weight: 700; letter-spacing: 1px; padding: 15px 40px; text-align:center; text-decoration:none; color:#FFFFFF; border-radius: 50px; background-color:#145388;">START
                                                                NOW</a>
                                                        </td>
                                                    </tr>
                                                </tbody>
                            ...
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td style="padding-top:0px; padding-bottom:20px; text-align: right;">
                                        <p style="font-size: 13px; line-height: 1; color:#145388;  margin-top:5px; vertical-align:top; white-space:nowrap;">$
                                            14.82</p>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td style="padding-top:0px; padding-bottom:5px; text-align: right; padding-left: 15px;">
                                        <p style="font-size: 13px; line-height: 1; margin-top:5px; vertical-align:top; color:#145388; white-space:nowrap; margin-bottom: 0;"><strong>$
                                                137.38</strong></p>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <table>
                                ...
                                <tr>
                                    <td style="padding-bottom: 30px;">
                                        ...
                                        <p style="font-size: 14px; line-height: 1; margin-top:5px;"><a style="color:#145388; text-decoration:initial;"
                                                href="#">Learn
                                                More</a></p>
                                    </td>
                                </tr>
